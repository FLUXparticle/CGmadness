...
{
	glMultiTexCoord2f(GL_TEXTURE0, 1.0f * gWaterAnim + u / 64.0f,
										1.0f * gWaterAnim + v / 64.0f + 0.33f);
	glMultiTexCoord2f(GL_TEXTURE1, 0.5f * gWaterAnim + u / 64.0f,
										0.5f * gWaterAnim + v / 64.0f);
}
